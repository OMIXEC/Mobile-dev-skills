#!/bin/bash
# Interactive install script for Codex CLI
...
print_header() {
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║           Mobile Skills Installer - Codex CLI              ║${NC}"
    echo -e "${CYAN}╚══════════════════════════════════════════════════════════╝${NC}"
    echo
}
...
install_global() {
    ...
    echo -e "${YELLOW}Restart Codex to use the new skills.${NC}"
}

install_project() {
    local project_dir=$(pwd)
    local project_skills_dir="$project_dir/.codex/skills"
