#!/bin/bash
# Interactive install script for Cursor
...
print_header() {
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║            Mobile Skills Installer - Cursor              ║${NC}"
    echo -e "${CYAN}╚══════════════════════════════════════════════════════════╝${NC}"
    echo
}
...
install_global() {
    local skills_dir="$HOME/.cursor/extensions/skills"
    mkdir -p "$skills_dir"
    ...
    echo -e "${YELLOW}Restart Cursor to use the new skills.${NC}"
}

install_project() {
    local project_dir=$(pwd)
    local project_skills_dir="$project_dir/.cursor/skills"
